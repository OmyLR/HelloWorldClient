...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="helloworld.com.web.service.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        helloworld.com.web.service.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
...
case 18:
        ...
        float subtractValue18mtemp = sampleHelloWorldProxyid.subtractValue(value_2idTemp);
